...
<div id="contents">
	<section class="page" id="page1">
		...
		<div style="width:1400px; margin:0 auto;">
			...
			제 1 조 (목적) 이 이용약관은 “강서구 마곡동 소개 소개 소개 (이하 "당 사이트")”에서 제공하는 인터넷 서비스(이하 '서비스')의 가입조건, 당 사이트와 이용자의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
			
			제 2 조 (용어의 정의)
			1. "이용자"라 함은 당 사이트에 접속하여 이 약관에 따라 당 사이트가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
			2. “강서구 마곡동 소개 소개 소개”에서 제공하는 단체표준, 단체인증, 예고현황 정보를 말합니다.
			3. "회원"이라 함은 서비스를 이용하기 위하여 당 사이트에 개인정보를 제공하여 아이디(ID)와 비밀번호를 부여 받은 자를 말합니다.
			4. “비회원”이하 함은 회원으로 가입하지 않고 " 강서구 마곡동 소개 소개 소개"에서 제공하는 서비스를 이용하는 자를 말합니다.
			...
			제 7 장 " 강서구 마곡동 소개 소개 소개" 게시물 운영정책
			
			제 20 조 (운영정책)
			"강서구 마곡동 소개 소개 소개" 각종 게시물에 대한 운영정책은 방송통신심의위원회의 정보통신에 관한 심의규정에 기반하며 이를 위반할 경우, "강서구 마곡동 소개 소개 소개" 운영정책에 의해 관련 게시물은 예고 없이 삭제, 이동될 수 있으며, 게시자(회원)는 아이디 이용제한 등 "강서구 마곡동 소개 소개 소개" 이용에 제한을 받을 수 있습니다.
			...
			- 공인이나 특정이슈와 관련한 당사자 또는 지인, 주변인 등을 사칭하여 게시물을 작성하거나, "강서구 마곡동 소개 소개 소개" 운영자를 사칭하여 작성된 내용
